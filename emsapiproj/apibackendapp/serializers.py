...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('EmployeeID', 'EmployeeName', 'Designation', 'Contact', 'DateOfJoining', 'DepartmentId', 'IsActive', 'Department', 'projects_details') # we can also use fields = '__all__' to serialize all the fields of the model but it is not a good practice to use it because it will serialize all the fields of the model which may not be required in the API response.
